...
export type ResponsiveValue = undefined | string | {
    [Breakpoint in BreakpointsAlias]?: string;
};
export declare function getResponsiveValue(componentName: string, componentProp: string, responsiveProp?: ResponsiveValue): {
    [k: string]: string;
};
export {};
