...
import { Pane } from '../Pane/Pane.esnext';
...
class PopoverOverlay extends PureComponent {
  ...
  contentNode = /*#__PURE__*/createRef();
  constructor(props) {
    super(props);
  ...
  renderPopover = overlayDetails => {
    ...
    }), /*#__PURE__*/React.createElement(UseFeatures, null, features => /*#__PURE__*/React.createElement(Box, {
      position: "relative",
      overflowX: "hidden",
      overflowY: "hidden",
      background: "bg",
