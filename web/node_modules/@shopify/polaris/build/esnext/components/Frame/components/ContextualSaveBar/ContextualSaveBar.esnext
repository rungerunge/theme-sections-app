...
import styles from './ContextualSaveBar.scss.esnext';
import { DiscardConfirmationModal } from './components/DiscardConfirmationModal/DiscardConfirmationModal.esnext';
