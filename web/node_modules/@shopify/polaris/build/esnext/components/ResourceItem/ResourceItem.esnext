...
class BaseResourceItem extends Component {
  ...
  node = null;
  overlayRef = /*#__PURE__*/createRef();
  buttonOverlay = /*#__PURE__*/createRef();
  ...
  handleSelection = (value, shiftKey) => {
    const {
      id,
      sortOrder,
      context: {
