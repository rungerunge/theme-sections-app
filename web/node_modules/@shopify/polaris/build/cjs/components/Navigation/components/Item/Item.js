...
var hooks$2 = require('../../../../utilities/features/hooks.js');
...
function Item({
  ...
  const itemClassName = css.classNames(Navigation.default.Item, disabled && Navigation.default['Item-disabled'], polarisSummerEditions2023 ? (selected || childIsActive) && Navigation.default['Item-selected'] : selected && canBeActive && Navigation.default['Item-selected'], showExpanded && Navigation.default.subNavigationActive, childIsActive && Navigation.default['Item-child-active']);
  ...
  if (subNavigationItems.length > 0) {
    ...
    }, /*#__PURE__*/React.createElement(Secondary.Secondary, {
  ...
  return /*#__PURE__*/React.createElement("li", {
    ...
    className: css.classNames(Navigation.default.ItemInnerWrapper, polarisSummerEditions2023 ? (selected || childIsActive) && Navigation.default['ItemInnerWrapper-selected'] : selected && canBeActive && Navigation.default['ItemInnerWrapper-selected'], displayActionsOnHover && Navigation.default['ItemInnerWrapper-display-actions-on-hover'], disabled && Navigation.default.ItemInnerDisabled)
