...
function useBannerColors(status = 'info', subduedClose = false) {
  const withinContentContainer = React.useContext(withinContentContext.WithinContentContext);
  const bannerColors = colorsByStatus[status][withinContentContainer ? 'withinContentContainer' : 'withinPage'];
  const iconRGBA = polarisTokens.color[`color-${bannerColors.icon}`];
  const noTitleCloseIconColor = polarisTokens.color[`color-icon-subdued`];
  return {
    iconRGBA,
    backgroundColor: bannerColors.background,
    textColor: bannerColors.text,
    statusIcon: polarisSummerEditions2023StatusIcon(status, iconRGBA),
    closeIcon: `<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.28033 5.21967C5.98744 4.92678 5.51256 4.92678 5.21967 5.21967C4.92678 5.51256 4.92678 5.98744 5.21967 6.28033L8.93934 10L5.21967 13.7197C4.92678 14.0126 4.92678 14.4874 5.21967 14.7803C5.51256 15.0732 5.98744 15.0732 6.28033 14.7803L10 11.0607L13.7197 14.7803C14.0126 15.0732 14.4874 15.0732 14.7803 14.7803C15.0732 14.4874 15.0732 14.0126 14.7803 13.7197L11.0607 10L14.7803 6.28033C15.0732 5.98744 15.0732 5.51256 14.7803 5.21967C14.4874 4.92678 14.0126 4.92678 13.7197 5.21967L10 8.93934L6.28033 5.21967Z" fill="${subduedClose ? noTitleCloseIconColor : iconRGBA}"/></svg>`
  };
}
...
function polarisSummerEditions2023StatusIcon(status = 'info', fill) {
...
exports.polarisSummerEditions2023StatusIcon = polarisSummerEditions2023StatusIcon;
exports.useBannerColors = useBannerColors;
